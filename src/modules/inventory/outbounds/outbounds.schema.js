// No unit_price/total_price here: unlike inbound, an outbound's stock-out cost
// always comes from FIFO allocation, never from a client-supplied price.
...
export const listOutboundsSchema = {
  tags: ['outbounds'],
...
export const getOutboundSchema = {
  tags: ['outbounds'],
  params: idParams,
  response: {
...
export const createOutboundSchema = {
  tags: ['outbounds'],
  body: documentBody,
  response: {
...
export const updateOutboundSchema = {
  tags: ['outbounds'],
  params: idParams,
  body: documentBody,
  response: {
...
export const deleteOutboundSchema = {
  tags: ['outbounds'],
  params: idParams,
  response: {
...
export const completeOutboundSchema = {
  tags: ['outbounds'],
  params: idParams,
...
export const cancelOutboundSchema = {
  tags: ['outbounds'],
  params: idParams,
  response: {
    200: { type: 'object', properties: { data: { type: 'object', properties: documentProperties } } },
