...
const headerProperties = {
  ...
  status: { type: 'string' },
  reversal_of_transfer_id: { type: ['integer', 'null'] },
...
const listQuerystring = {
  ...
  properties: {
    source_warehouse_id: { type: 'integer' },
    destination_warehouse_id: { type: 'integer' },
    status: { type: 'string', enum: ['DRAFT', 'APPROVED', 'COMPLETED', 'CANCELLED'] },
...
const documentBody = {
  type: 'object',
  required: ['source_warehouse_id', 'destination_warehouse_id', 'transfer_date', 'details'],
  additionalProperties: false,
  properties: {
    source_warehouse_id: { type: 'integer' },
    destination_warehouse_id: { type: 'integer' },
...
export const listStockTransfersSchema = {
...
export const getStockTransferSchema = {
  tags: ['stock-transfers'],
  params: idParams,
  response: {
...
export const createStockTransferSchema = {
  tags: ['stock-transfers'],
  body: documentBody,
  response: {
...
export const updateStockTransferSchema = {
  tags: ['stock-transfers'],
  params: idParams,
  body: documentBody,
  response: {
...
export const deleteStockTransferSchema = {
  tags: ['stock-transfers'],
  params: idParams,
  response: {
...
export const approveStockTransferSchema = {
  tags: ['stock-transfers'],
  params: idParams,
  response: {
    200: { type: 'object', properties: { data: { type: 'object', properties: documentProperties } } },
...
export const completeStockTransferSchema = {
  tags: ['stock-transfers'],
  params: idParams,
...
export const cancelStockTransferSchema = {
  tags: ['stock-transfers'],
  params: idParams,
  response: {
    200: { type: 'object', properties: { data: { type: 'object', properties: documentProperties } } },
